...
<form method="POST" action="modules/quanlybaiviet/xuly.php" enctype="multipart/form-data">
 <tr>
    <td>Tên bài viết</td>
    <td><textarea rows="2" name="tenbaiviet" style="resize: none;"></textarea></td>
  </tr>
  ...
  <tr>
    <td>Nội dung</td>
    <td><textarea rows="15" name="noidung" style="resize: none;"></textarea></td>
  </tr>
  <tr>
    <td>Hình ảnh</td>
  ...
  <tr>
    ...
    <td colspan="2" style="text-align: center;"><input type="submit" name="thembaiviet" value="Thêm bài viết"></td>
  </tr>
  </form>
</table>